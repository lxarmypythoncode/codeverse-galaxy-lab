        ...
        <div className="mb-12">
          ...
          <div className="cosmic-card p-6 mb-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
              <div>
                <h2 className="font-orbitron text-2xl mb-1">{selectedRoadmap.title}</h2>
                <p className="text-gray-400">{selectedRoadmap.description}</p>
              </div>
              <div className="mt-4 md:mt-0 flex items-center">
                <div className="mr-4">
                  <div className="text-sm text-gray-400">Your Progress</div>
                  <div className="text-xl font-orbitron text-neon-purple">
                    {Math.round(getProgress(selectedRoadmap.id))}%
                  </div>
                </div>
                <div className="w-32">
                  <div className="progress-track">
                    <div 
                      ...
                      style={{ width: `${getProgress(selectedRoadmap.id)}%` }}
                    ></div>
                  </div>
                </div>
              </div>
